"""
evaluate_smoke.py - Evaluate a saved smoke-classifier checkpoint.

Usage:
  python evaluate_smoke.py --data_dir smoke_dataset --split test --checkpoint runs/smoke_classifier/best_model.pt
"""
