"""
infer_smoke.py - Run inference on a single image for smoke detection.

Usage:
  python infer_smoke.py --image image.jpg --checkpoint runs/smoke_classifier/best_model.pt

Output (stdout, JSON):
  {"prediction": "Smoke | No Smoke", "confidence": 0.00}
"""
...
def main():
    ...
    ap.add_argument("--checkpoint", default="runs/smoke_classifier/best_model.pt")
    args = ap.parse_args()
