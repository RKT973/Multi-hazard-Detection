"""
evaluate.py - Evaluate a saved checkpoint on a dataset split (default: test).

Usage:
  python evaluate.py --data_dir dataset --split test --checkpoint runs/fire_classifier/best_model.pt
"""
...
CLASSES = ["controlled_fire", "no_fire", "uncontrolled_fire"]  # alphabetical, matches ImageFolder default
