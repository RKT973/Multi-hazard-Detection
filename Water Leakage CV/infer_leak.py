"""
infer_leak.py - Run inference on a single image for water leak detection.

Usage:
  python infer_leak.py --image image.jpg --checkpoint runs/leak_classifier/best_model.pt

Output (stdout, JSON):
  {"prediction": "Leak | No Leak", "confidence": 0.00}
"""
