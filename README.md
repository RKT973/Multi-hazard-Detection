...
Developed as an academic project under the Department of Computer Science and Engineering.
...
Since this is likely to be showcased on GitHub and included in your résumé, I'd also recommend adding:
- Project screenshots (dashboard, sensor setup, and predictions)
- A system architecture diagram
- GIF/video demo
- Accuracy metrics for each CV model (confusion matrices, precision, recall, F1)
- Hardware wiring diagram

Those additions would make the repository look significantly more polished and closer to an industry-standard open-source project.